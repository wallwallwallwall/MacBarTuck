...
当前测试集包含 36 项规则测试、17 项运行策略检查、44 项菜单项检查、19 项程序坞及菜单操作检查和 14 项权限状态检查，共 130 项。系统授权及激活策略测试主要使用替身，另覆盖实际 AppKit 重复设置策略的返回行为；不修改本机授权。这些测试不能代替真实收纳和点击验收。
...
产物位于 `dist/BarTuck-0.1.5.dmg`，并附带 SHA-256 文件。
