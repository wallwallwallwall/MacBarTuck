...
产物位于 `dist/MacBarTuck-0.1.20.dmg`，并附带 SHA-256 文件。
...
- 临时签名的应用在更新代码后可能需要重新授予系统权限。0.1.20 使用 Xcode 27 和 macOS 27 SDK 构建；macOS 15/26 由兼容策略回归覆盖，但本轮没有对应老系统真机。
