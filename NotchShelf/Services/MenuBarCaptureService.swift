...
final class MenuBarCaptureService {
    ...
    private let logger = Logger(subsystem: "com.notchshelf.app", category: "capture")
    ...
    private nonisolated static func legacyWindowImage(ids: [CGWindowID]) -> CGImage? {
        ...
        return pointers.withUnsafeMutableBufferPointer { buffer in
            ...
            return NotchShelfCreateWindowListImage(
                .null,
                array,
...
private func NotchShelfCreateWindowListImage(
    _ bounds: CGRect,
    _ windows: CFArray,
